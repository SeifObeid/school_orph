                ...
                <div class="col-lg-3 col-md-6">
                    <div class="input-group mb-3">
                        ...
                        <datalist id="select_sub_category">
                            ...
                            <option data-customvalue={{ $subCategory->id }} value="{{ $subCategory->name }}">
                                @endforeach
                        </datalist>
                        @endif
                        <input type='hidden' name="subCategory" value="" id="subCategoryInput">
                    </div>
                </div>
                                    ...
                                    <div class="col-8 ">
                                        <div class="input-group mb-3">
                                            ...
                                            <datalist id="selectProduct">
                                                ...
                                                <option data-customvalue={{ $post->id }} value="{{
                                                    $post->product_name
                                                    }}">
...
<script>
    $(document).ready(function(){
            ...
            $("#subCategoryInput").val(subCategoryValue)
